...
$(function () {
  var dt_ajax_table = $('.upcoming-events'),
    select2 = $('.select2'),
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return '<img src="/storage/upcoming/' + $image + '" class="news-id" style="width:200px"/>';
          }
        },
        {
          // news title
        ...
        },
        {
          ...
          render: function render(data, type, full, meta) {
            ...
            return '<span class="news-start-date">' + $start_date + '</span>';
          }
        },
        {
          // news end_date
          ...
          render: function render(data, type, full, meta) {
            ...
            return '<span class="news-end-date">' + $end_date + '</span>';
          }
        },
        {
          // news status
  ...
  $(document).on('click', '.edit-record', function () {
    ...
    // get data
    $.get(''.concat(baseUrl, 'data-upcoming/').concat(news_id, '/edit'), function (data) {
      $('#id').val(data.id);
    ...
    var fv = FormValidation.formValidation(editData, {
      ...
      $.ajax({
        ...
        url: ''.concat(baseUrl, 'data-upcoming'),
        type: 'POST',
  ...
  $(document).on('click', '.delete-record', function () {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          type: 'DELETE',
          url: ''.concat(baseUrl, 'data-upcoming/').concat(news_id),
