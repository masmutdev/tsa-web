...
<div class="row">
  ...
  <div class="card">
    <h5 class="card-header">Masukkan Data Pemasukan</h5>
    <div class="card-body">
      <form action="/simpan-finance" method="POST">
      @csrf
      <div class="mb-3">
        <label for="needs_income">Keperluan</label>
        <input class="form-control" type="text" name="needs_income" placeholder="Makanan" id="needs_income" required>
      </div>
      <div class="mb-3">
        <label for="price_income">Harga</label>
        <input class="form-control" type="number" name="price_income" id="price_income" required>
      </div>
      <div class="mb-3">
