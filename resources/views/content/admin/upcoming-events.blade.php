...
@section('page-script')
<script src="{{asset('js/upcoming-events.js')}}"></script>
...
<div class="card">
  <div class="d-flex flex-row justify-content-end mt-2">
    <button class="tambah-data btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#modalTambahData"><i class="bx bx-plus me-2"></i>Add Upcoming Events</button>
  </div>
  <div class="card-datatable text-nowrap">
    <table class="upcoming-events table table-bordered">
      <thead>
        <tr>
          <th></th>
          <th>No.</th>
    ...
    <div class="modal-dialog modal-fullscreen" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalEditTitle">Add Upcoming Events</h5>
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <div class="mb-3">
                  ...
                  <input type="date" class="form-control" placeholder="start_date" name="start_date" aria-label="start_date" required/>
                </div>
                <div class="mb-3">
                  <label class="end_date" for="end_date">End Date</label>
                  <input type="date" class="form-control" placeholder="end_date" name="end_date" aria-label="end_date" required/>
                </div>
              </div>
            </div>
          </div>
