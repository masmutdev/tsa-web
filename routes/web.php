...
use App\Http\Controllers\admin\Memo;
use Illuminate\Support\Facades\Route;
use App\Http\Controllers\admin\Entrepreneur;
use App\Http\Controllers\admin\FilesManager;
use App\Http\Controllers\admin\EventCalendar;
use App\Http\Controllers\admin\NewsManagement;
use App\Http\Controllers\admin\UpcomingEvents;
use App\Http\Controllers\admin\UsersManagementTSA;
...
Route::get('/login-area', $controller_path . '\authentications\LoginCover@index')->name('login-area');
Route::post('/login', [LoginCover::class, 'login'])->name('login-process');
Route::post('/logout', [LoginCover::class, 'logout'])->name('logout');

Route::get('/register-area', $controller_path . '\authentications\RegisterCover@index')->name('register-area');

Route::middleware(['checkLogin', 'lastActivity'])->group(function () {
  $controller_path_tsa = 'App\Http\Controllers\admin';

  Route::get('/dashboard', $controller_path_tsa . '\Dashboard@index')->name('dashboard');
  Route::get('/users-management-tsa', $controller_path_tsa . '\UsersManagementTSA@UsersManagementTSA')->name('users-management-tsa');
  Route::resource('/data-users', UsersManagementTSA::class);

  Route::get('/news-management', $controller_path_tsa . '\NewsManagement@NewsManagement')->name('news-management');
  Route::get('/edit-news-management/{id}', $controller_path_tsa . '\NewsManagement@EditNewsManagement')->name('edit-news-management');
  Route::resource('/data-news', NewsManagement::class);

  Route::get('/upcoming-events', $controller_path_tsa . '\UpcomingEvents@UpcomingEvents')->name('upcoming-events');
  Route::get('/edit-upcoming-events/{id}', $controller_path_tsa . '\UpcomingEvents@EditUpcomingEvents')->name('edit-upcoming-events');
  Route::resource('/data-upcoming', UpcomingEvents::class);

  Route::get('/memo', $controller_path_tsa . '\Memo@index')->name('memo');
  Route::post('/data-memo', [Memo::class, 'simpan_memo'])->name('simpan-memo');
  Route::post('/edit-memo', [Memo::class, 'edit_memo'])->name('edit-memo');
  Route::post('/bersihkan-memo', [Memo::class, 'bersihkan_memo'])->name('bersihkan-memo');

  Route::get('/files-manager', $controller_path_tsa . '\FilesManager@index')->name('files-manager');
  Route::post('/upload-file', [FilesManager::class, 'upload_file'])->name('upload-file');
  Route::post('/bersihkan-files', [FilesManager::class, 'bersihkan_files'])->name('bersihkan-files');

  Route::get('/event-calendar', $controller_path_tsa . '\EventCalendar@index')->name('event-calendar');
  Route::post('/tambah-event', [EventCalendar::class, 'simpan_event'])->name('simpan-event');

  Route::get('/entrepreneur-main', $controller_path_tsa . '\Entrepreneur@Entrepreneur')->name('entrepreneur-main');
  Route::get('/income', $controller_path_tsa . '\Income@index')->name('income');
  Route::get('/spend', $controller_path_tsa . '\Spend@index')->name('spend');
  Route::resource('/data-finance', Entrepreneur::class);
  Route::post('/simpan-finance', $controller_path_tsa . '\Entrepreneur@simpan_finance')->name('simpan-finance');
...
Route::get('/profil-tsa', $controller_path . '\home\Profil@index')->name('profil-tsa');
Route::get('/visi-misi', $controller_path . '\home\VisiMisi@index')->name('visi-misi');
Route::get('/struktur-organisasi', $controller_path . '\home\StrukturOrganisasi@index')->name('struktur-organisasi');
Route::get('/central', $controller_path . '\home\Central@index')->name('central');
Route::get('/leadership', $controller_path . '\home\Leadership@index')->name('leadership');
Route::get('/public-relation', $controller_path . '\home\PublicRelation@index')->name('public-relation');
Route::get('/sport-art', $controller_path . '\home\SportArt@index')->name('sport-art');
Route::get('/entrepreneur', $controller_path . '\home\Entrepreneur@index')->name('entrepreneur');
Route::get('/education', $controller_path . '\home\Education@index')->name('education');
Route::get('/language', $controller_path . '\home\Language@index')->name('language');
Route::get('/isi-berita/{id}', $controller_path . '\home\IsiBerita@index')->name('isi-berita');
Route::get('/berita', $controller_path . '\home\Berita@index')->name('berita');
Route::get('/galeri', $controller_path . '\home\Galeri@index')->name('galeri');
Route::get('/hubungi-kami', $controller_path . '\home\HubungiKami@index')->name('hubungi-kami');
Route::get('/kotak-saran', $controller_path . '\home\KotakSaran@index')->name('kotak-saran');
